...
export function NavbarWithSearch() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a href="#" className="font-chakra flex items-center">
          Sell Products
        </a>
      </Typography>
      ...
      >
        <SlLogin className="text-gray-700" size={18} />
  ...
  return (
    <Navbar className="rounded-tl-none rounded-tr-none mx-auto  px-4 py-2 lg:px-8 lg:py-4">
      <div
      ...
      >
        <Typography
          as="a"
          href="#"
          className="mr-4 cursor-pointer py-1.5 font-medium font-chakra"
          onClick={() => {
            navigate("/");
          }}
        >
